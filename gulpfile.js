...
var paths = {
	src: {
		...
		imgFiles: 'src/image/**/*',
		scssFiles: ['src/**/*.scss','!src/assets/scss/*','!src/assets/scss/section/*'],
		baseFiles: ['src/**/*.{png,js,json}','!src/assets/**/*','!src/section/**/*', '!src/image/**/*'],
		assetsDir: 'src/assets',
		assetsImgFiles: 'src/assets/images/**/*.{png,jpg,jpeg,svg,gif}',
		wxmlFiles: ['src/**/*.wxml','!src/section/**/*.wxml'],
		jsFiles: 'src/**/*.js',
	},
	dist: {
		baseDir: 'dist',
